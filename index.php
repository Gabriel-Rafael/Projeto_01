...
<head>
	...
	<meta name="description" content="Este é um site desenvolvido pelos alunos do curso de deselvolvimento web da Danki Code.">
...
<base base="<?php echo INCLUDE_PATH; ?>" />
	...
	<header>
		<div class="center">
			<div class="logo left"><a href="/"><?php echo $infoSite['logo_nome']; ?></a></div><!--logo-->
