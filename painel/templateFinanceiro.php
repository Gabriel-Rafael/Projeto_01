...
<div class="box">
    ...
    ?>
    <h2><i class="fa-solid fa-id-card"></i> Pagamentos <?php echo $nome ?></h2>
    ...
    <table>
        ...
        <?php
            if($nome == 'Pendentes')
                ...
                $nome = 1;
            $sql = MySql::conectar()->prepare("SELECT * FROM `tb_admin.financeiro` WHERE status = $nome ORDER BY vencimento ASC LIMIT 10");
            $sql->execute();
