    ...
    <form class="ajax" atualizar action="<?php echo INCLUDE_PATH_PAINEL ?>ajax/forms.php" method="post" enctype="multipart/form-data">
        ...
        <?php
            if(isset($_POST['acao'])){
                ...
                Painel::alert('sucesso','O(s) pagamento foi inserido com sucesso!');
                }
            }  
        ...
        <table>
            ...
            <tr <?php echo $style; ?>>    
                ...
                <td><a style="background: #002966;" class="btn" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-cliente?id=<?php echo $id?>&pago=<?php echo $value['id'] ?>"><i class="fa-solid fa-check"></i> Pago</a></td>
            </tr>
