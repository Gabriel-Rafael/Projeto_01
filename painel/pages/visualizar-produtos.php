...
<div class="box-content">
    <h2><i class="fa fa-pencil"></i> Produtos no estoque</h2>
    <div class="busca">
        <form method="post">
    ...
    <?php
        ...
        if(isset($_POST['atualizar'])){
            ...
            if($quantidade < 0){
                ...
                Painel::alert('sucesso','Você atualizou a quantidade do produto com ID: <br>'.$_POST['produto_id'].'</br>');
            }   
        }
...
<?php }else{ ?>
<div class="box-content">
    <h2><i class="fa fa-pencil"></i><a href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-produtos">Produtos no estoque</a> > Produtos em falta</h2>
    <?php
        if(isset($_POST['atualizar'])){
            $quantidade = $_POST['quantidade'];
            $produto_id = $_POST['produto_id'];
