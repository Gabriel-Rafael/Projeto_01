...
<div class="box-content">
    ...
    <form method="post" action="<?php echo INCLUDE_PATH_PAINEL ?>editar-produto?id=<?php echo $id; ?>" enctype="multipart/form-data">
        ...
        <a style="font-size: 14px;padding:4px 10px;" class="btn delete" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-imovel?id=<?php echo $id ?>&deletarImovel"><i class="fa fa-times"></i> Excluir Imóvel</a>

    </form>
    <div class="card-title"><i class="fa-solid fa-image"></i> Imagens do Imóvel:</div>
    <div class="boxes">
        <?php 
            foreach ($pegaImagens as $key => $value) {         
        ?>
