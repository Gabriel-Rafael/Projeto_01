...
<div class="box-content">
    <h2><i class="fa fa-pencil"></i> Empreendimento: <?php echo $infoEmpreend['nome'] ?></h2>
    <div class="info-item">
        <div class="row1">
            <div class="card-title"><i class="fa-solid fa-circle-info"></i> Imagem do empreendimento:</div>
            <img src="<?php echo INCLUDE_PATH_PAINEL ?>uploads/<?php echo $infoEmpreend['imagem'] ?>" alt="imagem do empreendimento selecionado">
        </div><!--row1-->
        <div class="row2">
            <div class="card-title"><i class="fa-solid fa-circle-info"></i> Informações do Empreendimento:</div>
            <p><i class="fa fa-pencil"></i> Nome Empreendimento: <?php echo $infoEmpreend['nome'] ?></p>
    ...
    <div class="card-title"><i class="fa-solid fa-circle-info"></i> Imóveis do empreendimento:</div>
    ...
    <table>
        ...
        <tr>
            ...
            <td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-imovel?id=<?php echo $value['id']; ?>"><i class="fa-solid fa-eye"></i> Visualizar</a></td>
