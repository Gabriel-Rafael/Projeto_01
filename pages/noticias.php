...
<section class="header-noticias">
    <div class="center">
        ...
        <h2>Acompanhe as ultimas <b>notícias do portal</b></h2>
    </div><!--center-->
</section>
...
<section class="container-portal">
    <div class="center">
        <div class="sidebar">
            ...
            <div class="box-content-sidebar">
                <h3><i class="fa-solid fa-arrow-right"></i> Selecione a categoria:</h3>
                <form action="">
                    ...
                    <div class="autor-box-portal">
                        ...
                        <div class="texto-autor-portal text-center">
                            ...
                            ?>
                                ...
                                <h3><?php echo substr($infoSite['descricao'],0,250).'...' ?></h3>
        ...
        <div class="conteudo-portal">
            <div class="header-conteudo-portal">
                <?php 
                    ...
                    if(@$categoria['nome'] == ''){
                        ...
                        echo '<h2><i class="fa-regular fa-circle-check"></i> Busca realizada com sucesso!</h2>';
                    }
            ...
            <div class="box-single-conteudo">
                ...
                <a href="<?php INCLUDE_PATH; ?>noticias/<?php echo $categoriaNome; ?>/<?php echo $value['slug']; ?>">Leia mais</a>
